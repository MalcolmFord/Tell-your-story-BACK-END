...
class FamilyUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_user" do
    assert_difference('FamilyUser.count') do
      post family_users_url, params: { family_user: { family_id: @family_user.family_id, user_id: @family_user.user_id } }, as: :json
    end
  ...
  test "should update family_user" do
    patch family_user_url(@family_user), params: { family_user: { family_id: @family_user.family_id, user_id: @family_user.user_id } }, as: :json
    assert_response 200
  end
